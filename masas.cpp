//En este codigo pretendemos generar los datos del indice M_anisotropica/M_isotropica usando el codigo anisotropico y teniendo en cuenta que el caso sin anisotropia se reduce haciendo alpha = beta y m = n
...
int main ()
{
	...
	while (req2 == 0)
		{
			k1_1 = func1(z2,w_2,w_prime2,m,m, beta, beta);
			k1_2 = func2(z2,w_2,w_prime2,m,m, beta, beta);
	
			k2_1 = func1(z2 + h/2.0, w_2 + h/2.0*k1_1, w_prime2 + h/2.0*k1_2,m,m, beta, beta);
			k2_2 = func2(z2 + h/2.0, w_2 + h/2.0*k1_1, w_prime2 + h/2.0*k1_2,m,m, beta, beta);

			k3_1 = func1(z2 + h/2.0, w_2 + h/2.0*k2_1, w_prime2 + h/2.0*k2_2,m,m, beta, beta);
			k3_2 = func2(z2 + h/2.0, w_2 + h/2.0*k2_1, w_prime2 + h/2.0*k2_2,m,m, beta, beta);

			k4_1 = func1(z2 + h, w_2 + h*k3_1, w_prime2 + h*k3_2,m,m, beta, beta);
			k4_2 = func2(z2 + h, w_2 + h*k3_1, w_prime2 + h*k3_2,m,m, beta, beta);
